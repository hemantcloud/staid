...
class ChangeEmailVerification extends StatefulWidget {
  String email;
  ChangeEmailVerification({Key? key,required this.email}) : super(key: key);

  @override
  State<ChangeEmailVerification> createState() => _ChangeEmailVerificationState();
}

class _ChangeEmailVerificationState extends State<ChangeEmailVerification> {
  ...
  Future<void> emailVerification(BuildContext context) async {
    ...
    var response = await http.post(Uri.parse(Urls.changeEmailVerificationUrl),
    ...
    ChangeEmailVerificationModel responseChangeEmailVerification = await ChangeEmailVerificationModel.fromJson(jsonResponse);
    if(responseChangeEmailVerification.status == true){
      UtilityToaster().getToast(responseChangeEmailVerification.message);
      setState(() {});
