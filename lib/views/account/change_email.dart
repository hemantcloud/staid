...
import 'package:staid/models/account/change_email_model.dart';
...
import 'package:staid/views/account/change_email_verification.dart';
...
class _ChangeEmailState extends State<ChangeEmail> {
  ...
  Future<void> changeEmail(BuildContext context) async {
    ...
    var response = await http.post(Uri.parse(Urls.changeEmailUrl),
    ...
    ChangeEmailModel responseChangeEmail = await ChangeEmailModel.fromJson(jsonResponse);
    if(responseChangeEmail.status == true){
      setState(() {});
      UtilityToaster().getToast(responseChangeEmail.message);
      Navigator.pushReplacement(context, MaterialPageRoute(builder: ((context) => ChangeEmailVerification(email: emailController.text,))));
    }else{
      setState(() {});
      UtilityToaster().getToast(responseChangeEmail.message);
    }
