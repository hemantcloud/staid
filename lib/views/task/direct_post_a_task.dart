...
class DirectPostATask extends StatefulWidget {
  const DirectPostATask({Key? key}) : super(key: key);

  @override
  State<DirectPostATask> createState() => _DirectPostATaskState();
}

class _DirectPostATaskState extends State<DirectPostATask> {
  ...
  // this will be selected category after selecting one of them
          ...
          children: [
                  ...
                  Expanded(
                    ...
                    DropdownButtonHideUnderline(
                      child: DropdownButton(
                        ...
                        items: categorylist!.map((Category model) {
                    ...
                    /* DropdownButtonFormField<Category>(
                      ...
                      onChanged: (Category? value) {
                        setState(() {
                          categorylistselected = value!.name.toString();
                          print('selectted category is ----');
                          print(categorylistselected);
                        });
                      },
                      decoration: const InputDecoration(
            ...
            InkWell(
              onTap: () {
                ...
                } else if(categorylistselected == null || categorylistselected == ''){
                  UtilityToaster().getToast("Please Select a Category.");
                }else{
                  addtask(context);
                }
              },
        ...
        content: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: ((context) => Dashboard(bottomIndex: 1))));
                },
                child: Container(
                  alignment: Alignment.center,
  ...
  Future<void> addtask(BuildContext context) async {
    ...
    var request = {};
    request['categoryid'] = categorylistselected;
